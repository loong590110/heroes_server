...
class HeroesServerChannel extends ApplicationChannel
  ...
  Future prepare() async {
    ...
    final config = HeroesServerConfiguration(options.configurationFilePath);
...
class HeroesServerConfiguration extends Configuration {
  HeroesServerConfiguration(String fileName) : super.fromFile(File(fileName));
