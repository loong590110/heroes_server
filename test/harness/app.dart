import 'package:heroes_server/model/user.dart';
import 'package:heroes_server/heroes_server.dart';
import 'package:aqueduct_test/aqueduct_test.dart';

export 'package:heroes_server/heroes_server.dart';
export 'package:aqueduct_test/aqueduct_test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for heroes_server.
///
...
///         }
///
class Harness extends TestHarness<HeroesServerChannel> with TestHarnessAuthMixin<HeroesServerChannel>, TestHarnessORMMixin {
  @override
